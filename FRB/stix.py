r"""
Make search_FRB plots of a large file.
"""
...
def make_waterfall_plots(input_file, chunk_count, plot_dir, width, height, dpi, source_name=None):
    r"""
    Make search_FRB plots of a given huge-ish file.
​
    Parameters
    ----------
    input_file : str
    ...
    wf1 = search_FRB(input_file, load_data=False)
    ...
    for ii in range(0, chunk_count):
        ...
        # read in data
        wf = search_FRB(input_file, f_start=ii_lowest, f_stop=ii_highest)
...
def cmd_tool(args=None):
    ...
    parser = ArgumentParser(description="Make search_FRB plots from a single file.")
