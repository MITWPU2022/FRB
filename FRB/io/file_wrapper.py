...
import FRB.io.sigproc

# import pdb;# pdb.set_trace()

from FRB.io.fil_reader import FilReader
from FRB.io.hdf_reader import H5Reader
...
def open_file(filename, f_start=None, f_stop=None,t_start=None, t_stop=None,load_data=True,max_load=None):
    ...
    *other*            Will raise NotImplementedError
    ...
    if FRB.io.sigproc.is_filterbank(filename):
        # Open FIL file
    ...
    raise NotImplementedError('Cannot open this type of file with search_FRB: {}'.format(filename))
