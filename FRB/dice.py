...
def cmd_tool(args=None):
    ...
    file_big = search_FRB(args.in_fname, max_load = args.max_load)
    ...
    # create search_FRB object
    file_small = search_FRB(args.in_fname, f_start = f_start_real, f_stop = f_stop_real, max_load = args.max_load)

    # write search_FRB object
